...
const App: React.FC = () => {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <header id="hero" className="relative h-[100svh] min-h-[600px] flex flex-col items-center justify-center overflow-hidden px-4 pt-32">
        ...
        >
          ...
          >
            <ScrambleText 
              text="MITUL NAYAKWADI" 
              className="text-[25px] sm:text-6xl md:text-7xl lg:text-8xl leading-[1.1] font-black font-heading tracking-tight text-white uppercase" 
            />
          </motion.div>
      ...
      <section id="about" className="relative z-10 py-24 md:py-32 border-b border-white/10 overflow-hidden bg-black/40 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-14 items-start">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-[400px] lg:max-w-full aspect-[3/4] rounded-3xl overflow-hidden border-2 border-white/20 hover:border-red-500/80 shadow-[0_0_30px_rgba(239,68,68,0.15)] hover:shadow-[0_0_40px_rgba(239,68,68,0.3)] group cursor-pointer transition-all duration-500 ease-in-out animate-fade-in bg-black">
      ...
      <section id="experience" className="relative z-10 py-24 md:py-32 border-b border-white/10 overflow-hidden bg-black/50 font-sans">
      ...
      <section id="education" className="relative z-10 py-24 md:py-32 bg-gradient-to-b from-black/20 to-black/40 border-b border-white/10 overflow-hidden">
      ...
      {/* SKILLS SECTION */}
      <section id="skills" className="relative z-10 py-24 md:py-32 bg-black/20 backdrop-blur-sm border-b border-white/10 overflow-hidden">
      ...
      <section id="projects" className="relative z-10 py-24 md:py-32 bg-black/40 border-b border-white/10 overflow-hidden">
      ...
      {/* CONTACT SECTION */}
      <section id="contact" className="relative z-10 py-24 md:py-32 px-4 md:px-6 bg-black/30 backdrop-blur-lg">
